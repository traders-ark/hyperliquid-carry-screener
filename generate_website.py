...
def generate_website():
    ...
    df_negative_avg = df_negative_avg.sort_values(by='fundingRate_percent_avg', ascending=False)
    ...
    df_negative_current = df_negative_current.sort_values(by='fundingRate_percent', ascending=False)
